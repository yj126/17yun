...
define('REFERER_URL', ''); //如：define('REFERER_URL', 'www.1717yun.com|123.1717yun.com|1717yun.com');

//此处设置防盗信息及错误提示
define('ERROR', '<html><meta name="robots" content="noarchive"><head><title>1717yun无广告解析 - 全网视频无广告解析</title></head><style>h1{color:#C7636C; text-align:center; font-family: Microsoft Jhenghei;}p{color:#f90; font-size: 1.2rem;text-align:center;font-family: Microsoft Jhenghei;}</style><body bgcolor="#000000"><table width="100%" height="100%" align="center"><td align="center"><h1>本站接口不对外开放</h1><p>如需使用，请联系本站管理员进行授权</p></table></body></html>');
//此处进行用户相关配置
$user = array(

		'uid' => '17174225', //填写你的UID信息,填写到单引号''里,用户授权UID，在 http://api.1717yun.com/ 平台可以查看到

		'token' => '0e8e9ce38a0978167d2b4231e044e8d7', //填写你的TOKEN密钥信息,填写到单引号''里,用户授权TOKEN密钥，在 http://api.1717yun.com/ 平台可以查看到
		...
		'dplayer' => '1717yun视频解析,https://www.1717yun.com', //用户设置dplayer播放器右键,不设置请留空。填写实例:'dplayer' => '1717yun视频解析,https://www.1717yun.com'
		
		'title' => '1717yun视频解析-https://www.1717yun.com', //设置解析页面title名称   例如：'title' => '1717yun视频解析',

		'skin' => '1', //ckplayer播放器样式共4种,修改参数后更换播放器样式. 参数说明：1,2,3,4

		'hand' => '1717yun视频解析,https://www.1717yun.com', //ckplayer播放器右键,例如:'hand'=>'1717yun视频解析,https://www.1717yun.com'
